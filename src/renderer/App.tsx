...
import { HashRouter, Outlet, Route, Routes, useNavigate, Navigate } from "react-router-dom";
              ...
              <Routes>
                <Route element={<RouteListener />}>
                  <Route element={<Layout />}>
                    ...
                    <Route path="/view_connection/:connectionID" element={<ConnectionView />} />
                    <Route path="/connectForm" element={<ConnectForm />} />
                    <Route path="/edit_connect/:connectionID" element={<ConnectForm />} />
                  </Route>
                </Route>
              </Routes>
            </HashRouter>
